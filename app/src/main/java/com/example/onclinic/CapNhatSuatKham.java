...
public class CapNhatSuatKham extends AppCompatActivity {
    ...
    private void xuLyCapNhat() {
        ...
        {
            Log.e("TestDULieu",ex.getMessage().toString());
    ...
    private void troVeManHinhSuatKham() {
        onBackPressed();
//        Intent intent = new Intent(CapNhatSuatKham.this,SuatKhamDaTao.class);
...
//        finish();
    ...
    private void hienThiCalendar() {
        ...
        Date date;
        try {
            date = sdf1.parse(lichKham.getNgayKham());
